...
import galleryImages from "../dataProduct/countryData";

const Products = ({ activeFilter, setActiveFilter }) => {
  ...
  const filteredImages = galleryImages.filter((image) => {
    ...
    const isRegionMatch =
      activeRegion === "all" || image.region === activeRegion;
    return isCategoryMatch && isRegionMatch;
  });
        ...
        {filteredImages.map((image, index) => {
          ...
          return imageSources.map((src, i) => (
            ...
            >
              ...
              {/* Add Price and Short Description */}
              <div className="absolute bottom-2 left bg-green-500 bg-opacity-80 text-white text-xs px-7 py-3 rounded-lg">
              ...
              <motion.button
                className="absolute bottom-12 right-2 bg-gray-200 text-white py-1 px-2 rounded-2xl shadow-lg hover:bg-[#008c3d]"
